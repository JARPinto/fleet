...
@login_required
def history():
    ''' Straightforward history of inputs '''
    db = get_db_connection()
...
@login_required
def dashboard():
    ''' Dashboard of year totals and montly summary'''
    db = get_db_connection()
    cursor = db.cursor()
